...
import electron_density_profile_globe_to_PSO
###############################################################################
...
def myfunc(x):
    x1 = x[0]
    x2 = x[1]
    return electron_density_profile_globe_to_PSO.e_density(x[0], x[1])

lb = [-89, -180]
ub = [90, 180]

xopt1, fopt1_inv = pso(myfunc, lb, ub)

print('The optimum is at:')
print('    {}'.format(xopt1))
print('Optimal function value:')
print('    myfunc: {}'.format(fopt1_inv**-1))
